package be.renaud11232.bluemapmobs.plugin.markerbuilder.other;

import be.renaud11232.bluemapmobs.markerbuilder.AbstractOtherEntityMarkerBuilder;
import be.renaud11232.bluemapmobs.plugin.markerbuilder.other.livingentity.ArmorStandMarkerBuilder;
import be.renaud11232.bluemapmobs.plugin.markerbuilder.other.livingentity.MannequinMarkerBuilder;
