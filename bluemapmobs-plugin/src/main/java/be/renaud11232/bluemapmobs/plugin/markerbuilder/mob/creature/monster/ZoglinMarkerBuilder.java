...
public class ZoglinMarkerBuilder extends AbstractMobMarkerBuilder<Zoglin> {
    public ZoglinMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
