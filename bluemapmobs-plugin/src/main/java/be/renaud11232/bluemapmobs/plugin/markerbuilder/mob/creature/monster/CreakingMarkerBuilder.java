...
public class CreakingMarkerBuilder extends AbstractMobMarkerBuilder<Creaking> {
    public CreakingMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
