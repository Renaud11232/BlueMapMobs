...
public class JungleBoatMarkerBuilder extends AbstractVehicleMarkerBuilder<JungleBoat> {
    public JungleBoatMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
