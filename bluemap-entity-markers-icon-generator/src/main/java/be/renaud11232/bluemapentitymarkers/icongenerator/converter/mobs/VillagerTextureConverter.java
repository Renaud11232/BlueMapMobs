...
public class VillagerTextureConverter extends TextureConverter {
    public VillagerTextureConverter() {
        super();
        ...
        registerTextureConversion((texture, icon) -> {
            ...
            BufferedImage outerLayer = texture.getSubimage(7, 37, 8, 8);
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^villager((?:_(?:desert|jungle|plains|savanna|snow|swamp|taiga))?)\\.png$")),
                        List.of("villager$1.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^villager((?:_(?:desert|jungle|plains|savanna|snow|swamp|taiga))?)_baby\\.png$")),
                        List.of("villager$1_baby.png")
                )
        );
    }
}
