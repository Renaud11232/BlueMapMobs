...
public class IllusionerTextureConverter extends TextureConverter {
    public IllusionerTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^illusioner\\.png$")),
                        List.of("illusioner.png")
                )
        );
    }
}
