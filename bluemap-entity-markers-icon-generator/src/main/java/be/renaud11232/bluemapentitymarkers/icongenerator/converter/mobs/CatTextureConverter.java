...
public class CatTextureConverter extends TextureConverter {
    public CatTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^cat_(all_black|black|british_shorthair|calico|jellie|persian|ragdoll|red|siamese|tabby|white)\\.png$")),
                        List.of("cat_$1.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^cat_(all_black|black|british_shorthair|calico|jellie|persian|ragdoll|red|siamese|tabby|white)_baby\\.png$")),
                        List.of("cat_$1_baby.png")
                )
        );
    }
}
