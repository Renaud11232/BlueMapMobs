...
public class SpruceBoatMarkerBuilder extends SimpleMarkerBuilder<SpruceBoat> {
    public SpruceBoatMarkerBuilder(BlueMapEntitiesAPI api) {
        super(api);
    }

    @Override
    public Icon getDefaultIcon() {
        return VehiclesIcon.SPRUCE_BOAT;
    }
}
