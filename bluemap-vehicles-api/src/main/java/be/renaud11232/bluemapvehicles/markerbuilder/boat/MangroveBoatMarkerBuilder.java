...
public class MangroveBoatMarkerBuilder extends SimpleMarkerBuilder<MangroveBoat> {
    public MangroveBoatMarkerBuilder(BlueMapEntitiesAPI api) {
        super(api);
    }

    @Override
    public Icon getDefaultIcon() {
        return VehiclesIcon.MANGROVE_BOAT;
    }
}
