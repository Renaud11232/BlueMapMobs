...
public class HopperMinecartMarkerBuilder extends AbstractVehicleMarkerBuilder<HopperMinecart> {
    public HopperMinecartMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
