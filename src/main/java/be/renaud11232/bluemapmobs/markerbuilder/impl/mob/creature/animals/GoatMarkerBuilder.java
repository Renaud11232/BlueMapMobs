...
public class GoatMarkerBuilder extends AbstractMobMarkerBuilder<Goat> {
    public GoatMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
