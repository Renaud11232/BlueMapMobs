...
public class WardenMarkerBuilder extends AbstractMobMarkerBuilder<Warden> {
    public WardenMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
