...
public class GiantMarkerBuilder extends AbstractMobMarkerBuilder<Giant> {
    public GiantMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
