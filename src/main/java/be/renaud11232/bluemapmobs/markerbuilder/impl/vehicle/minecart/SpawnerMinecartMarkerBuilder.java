...
public class SpawnerMinecartMarkerBuilder  extends AbstractVehicleMarkerBuilder<SpawnerMinecart> {
    public SpawnerMinecartMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
