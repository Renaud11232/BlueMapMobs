...
public class DolphinMarkerBuilder extends AbstractMobMarkerBuilder<Dolphin> {
    public DolphinMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
