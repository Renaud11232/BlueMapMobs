...
public class FabricTropicalFish extends FabricMob<net.minecraft.world.entity.animal.fish.TropicalFish> implements TropicalFish {
    public FabricTropicalFish(net.minecraft.world.entity.animal.fish.TropicalFish wrapped) {
        super(wrapped);
    }
    ...
    public Color getBodyColor() {
        return mapColor(wrapped.getBaseColor());
    }
