package be.renaud11232.bluemapcitizensmarkers.bukkit.icon;
...
class CitizensSkinIcon extends SimpleIcon {
    CitizensSkinIcon(Path webroot, URL skin, String path, Vector2i anchor) throws IOException {
    ...
    private static String generateSkinIconPath(Path webroot, String pathTemplate, URL skin) throws IOException {
        String relativePath = pathTemplate.replace("{id}", Path.of(skin.getPath()).getFileName().toString());
