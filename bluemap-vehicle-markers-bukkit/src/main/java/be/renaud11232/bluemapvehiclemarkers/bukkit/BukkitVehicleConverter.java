...
import be.renaud11232.bluemapvehiclemarkers.bukkit.entity.BukkitUnknownVehicle;
import be.renaud11232.bluemapvehiclemarkers.bukkit.entity.boat.BukkitChestRaft;
import be.renaud11232.bluemapvehiclemarkers.bukkit.entity.boat.BukkitRaft;
import be.renaud11232.bluemapvehiclemarkers.bukkit.entity.boat.BukkitRideableBoat;
import be.renaud11232.bluemapvehiclemarkers.bukkit.entity.boat.BukkitRideableChestBoat;
import be.renaud11232.bluemapvehiclemarkers.bukkit.entity.minecart.*;
import org.bukkit.entity.Vehicle;
import org.bukkit.entity.boat.*;
import org.bukkit.entity.minecart.*;

public class BukkitVehicleConverter implements EntityConverter<Vehicle, be.renaud11232.bluemapvehiclemarkers.entity.Vehicle> {
    @Override
    public be.renaud11232.bluemapvehiclemarkers.entity.Vehicle convert(Vehicle vehicle) {
