...
public class MobsIcon {
    ...
    public static final Icon AXOLOTL_CYAN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/axolotl/axolotl_cyan.png", new Vector2i(12, 12));
    public static final Icon AXOLOTL_BLUE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/axolotl/axolotl_blue.png", new Vector2i(12, 12));
    ...
    public static final Icon BEE_NECTAR_NONE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/bee/bee_nectar_none.png", new Vector2i(12, 12));
    public static final Icon BEE_NECTAR_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/bee/bee_nectar_baby.png", new Vector2i(12, 12));
    public static final Icon BEE_NECTAR_NONE_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/bee/bee_nectar_none_baby.png", new Vector2i(12, 12));
    ...
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 5x4+5+5 -sample 600% \) -geometry +1+7 -composite \( ${TEXTURE}.png -crop 3x2+2+26 -sample 600% \) -geometry +7+19 -composite \( ${TEXTURE}.png -crop 1x1+2+12 -sample 600% \) -geometry +4+1 -composite \( ${TEXTURE}.png -crop 1x1+8+12 -sample 600% \) -geometry +22+1 -composite -strip ${TEXTURE}_out.png
    public static final Icon CAT_WHITE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cat/cat_white.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 5x4+5+5 -sample 600% \) -geometry +1+7 -composite \( ${TEXTURE}.png -crop 3x2+2+26 -sample 600% \) -geometry +7+19 -composite \( ${TEXTURE}.png -crop 1x1+2+12 -sample 600% \) -geometry +4+1 -composite \( ${TEXTURE}.png -crop 1x1+8+12 -sample 600% \) -geometry +22+1 -composite -strip ${TEXTURE}_out.png
    public static final Icon CAT_CALICO = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cat/cat_calico.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 5x4+5+5 -sample 600% \) -geometry +1+7 -composite \( ${TEXTURE}.png -crop 3x2+2+26 -sample 600% \) -geometry +7+19 -composite \( ${TEXTURE}.png -crop 1x1+2+12 -sample 600% \) -geometry +4+1 -composite \( ${TEXTURE}.png -crop 1x1+8+12 -sample 600% \) -geometry +22+1 -composite -strip ${TEXTURE}_out.png
    public static final Icon CAT_JELLIE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cat/cat_jellie.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 5x4+5+5 -sample 600% \) -geometry +1+7 -composite \( ${TEXTURE}.png -crop 3x2+2+26 -sample 600% \) -geometry +7+19 -composite \( ${TEXTURE}.png -crop 1x1+2+12 -sample 600% \) -geometry +4+1 -composite \( ${TEXTURE}.png -crop 1x1+8+12 -sample 600% \) -geometry +22+1 -composite -strip ${TEXTURE}_out.png
    public static final Icon CAT_PERSIAN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cat/cat_persian.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 5x4+5+5 -sample 600% \) -geometry +1+7 -composite \( ${TEXTURE}.png -crop 3x2+2+26 -sample 600% \) -geometry +7+19 -composite \( ${TEXTURE}.png -crop 1x1+2+12 -sample 600% \) -geometry +4+1 -composite \( ${TEXTURE}.png -crop 1x1+8+12 -sample 600% \) -geometry +22+1 -composite -strip ${TEXTURE}_out.png
    public static final Icon CAT_RAGDOLL = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cat/cat_ragdoll.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 5x4+5+5 -sample 600% \) -geometry +1+7 -composite \( ${TEXTURE}.png -crop 3x2+2+26 -sample 600% \) -geometry +7+19 -composite \( ${TEXTURE}.png -crop 1x1+2+12 -sample 600% \) -geometry +4+1 -composite \( ${TEXTURE}.png -crop 1x1+8+12 -sample 600% \) -geometry +22+1 -composite -strip ${TEXTURE}_out.png
    ...
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 4x6+3+3 -sample 400% \) -geometry +8+4 -composite \( ${TEXTURE}.png -crop 4x2+16+2 -sample 400% \) -geometry +8+12 -composite -strip ${TEXTURE}_out.png
    ...
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 4x4+4+4 -sample 400% \) -geometry +8+8 -composite \( ${TEXTURE}.png -crop 2x1+11+9 -sample 400% \) -geometry +12+16 -composite -strip ${TEXTURE}_out.png
    ...
    public static final Icon COPPER_GOLEM_UNAFFECTED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/copper_golem/copper_golem_unaffected.png", new Vector2i(12, 12));
    ...
    public static final Icon COPPER_GOLEM_WEATHERED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/copper_golem/copper_golem_weathered.png", new Vector2i(12, 12));
    public static final Icon COPPER_GOLEM_OXIDIZED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/copper_golem/copper_golem_oxidized.png", new Vector2i(12, 12));
    ...
    public static final Icon COW_TEMPERATE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cow/cow_temperate.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 8x8+6+6 -sample 400% \) -geometry +0+0 -composite \( ${TEXTURE}.png -crop 6x3+10+34 -sample 400% \) -geometry +4+20 -composite -strip ${TEXTURE}_out.png
    public static final Icon COW_COLD = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cow/cow_cold.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 8x8+6+6 -sample 400% \) -geometry +0+0 -composite \( ${TEXTURE}.png -crop 6x3+2+34 -sample 400% \) -geometry +4+20 -composite -strip ${TEXTURE}_out.png
    public static final Icon COW_WARM = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cow/cow_warm.png", new Vector2i(12, 12));
    ...
    public static final Icon COW_TEMPERATE_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cow/cow_temperate_baby.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 6x6+5+23 -sample 400% \) -geometry +4+4 -composite \( ${TEXTURE}.png -crop 4x3+13+30 -sample 400% \) -geometry +8+16 -composite -strip ${TEXTURE}_out.png
    public static final Icon COW_COLD_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cow/cow_cold_baby.png", new Vector2i(12, 12));
    //magick -size 32x32 xc:none \( ${TEXTURE}.png -crop 6x6+5+23 -sample 400% \) -geometry +4+4 -composite \( ${TEXTURE}.png -crop 4x3+13+30 -sample 400% \) -geometry +8+16 -composite -strip ${TEXTURE}_out.png
    public static final Icon COW_WARM_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/cow/cow_warm_baby.png", new Vector2i(12, 12));
    ...
    public static final Icon HAPPY_GHAST_HARNESS_LIGHT_GRAY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_light_gray.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_GRAY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_gray.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_BLACK = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_black.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_BROWN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_brown.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_RED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_red.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_ORANGE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_orange.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_YELLOW = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_yellow.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_LIME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_lime.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_GREEN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_green.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_CYAN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_cyan.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_LIGHT_BLUE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_light_blue.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_BLUE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_blue.png", new Vector2i(12, 12));
    public static final Icon HAPPY_GHAST_HARNESS_PURPLE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/happy_ghast/happy_ghast_harness_purple.png", new Vector2i(12, 12));
    ...
    public static final Icon HUSK = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/husk/husk.png", new Vector2i(12, 12));
    public static final Icon HUSK_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/husk/husk_baby.png", new Vector2i(12, 12));
    ...
    public static final Icon LLAMA_DECOR_NONE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_none.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_WHITE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_white.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_LIGHT_GRAY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_light_gray.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_GRAY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_gray.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_BLACK = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_black.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_BROWN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_brown.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_RED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_red.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_ORANGE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_orange.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_YELLOW = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_yellow.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_LIME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_lime.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_GREEN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_green.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_CYAN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_cyan.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_LIGHT_BLUE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_light_blue.png", new Vector2i(12, 12));
    public static final Icon LLAMA_DECOR_BLUE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/llama/llama_decor_blue.png", new Vector2i(12, 12));
    ...
    public static final Icon PANDA_PLAYFUL = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/panda/panda_playful.png", new Vector2i(12, 12));
    ...
    public static final Icon PARROT_GREEN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/parrot/parrot_green.png", new Vector2i(12, 12));
    public static final Icon PARROT_CYAN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/parrot/parrot_cyan.png", new Vector2i(12, 12));
    ...
    public static final Icon RABBIT_GOLD = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/rabbit/rabbit_gold.png", new Vector2i(12, 12));
    public static final Icon RABBIT_WHITE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/rabbit/rabbit_white.png", new Vector2i(12, 12));
    public static final Icon RABBIT_BLACK_AND_WHITE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/rabbit/rabbit_black_and_white.png", new Vector2i(12, 12));
    public static final Icon RABBIT_BLACK = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/rabbit/rabbit_black.png", new Vector2i(12, 12));
    public static final Icon RABBIT_BROWN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/rabbit/rabbit_brown.png", new Vector2i(12, 12));
    ...
    public static final Icon WOLF_ASHEN_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_ashen_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_BLACK_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_black_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_CHESTNUT_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_chestnut_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_RUSTY_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_rusty_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_SNOWY_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_snowy_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_SPOTTED_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_spotted_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_STRIPED_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_striped_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_WOODS_ANGRY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_woods_angry.png", new Vector2i(12, 12));
    public static final Icon WOLF_ASHEN = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_ashen.png", new Vector2i(12, 12));
    public static final Icon WOLF_BLACK = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_black.png", new Vector2i(12, 12));
    public static final Icon WOLF_CHESTNUT = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_chestnut.png", new Vector2i(12, 12));
    public static final Icon WOLF = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf.png", new Vector2i(12, 12));
    public static final Icon WOLF_RUSTY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_rusty.png", new Vector2i(12, 12));
    public static final Icon WOLF_SNOWY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_snowy.png", new Vector2i(12, 12));
    public static final Icon WOLF_SPOTTED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_spotted.png", new Vector2i(12, 12));
    public static final Icon WOLF_STRIPED = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_striped.png", new Vector2i(12, 12));
    public static final Icon WOLF_WOODS = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_woods.png", new Vector2i(12, 12));
    public static final Icon WOLF_ASHEN_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_ashen_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_BLACK_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_black_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_CHESTNUT_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_chestnut_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_RUSTY_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_rusty_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_SNOWY_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_snowy_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_SPOTTED_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_spotted_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_STRIPED_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_striped_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_WOODS_TAME = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_woods_tame.png", new Vector2i(12, 12));
    public static final Icon WOLF_ASHEN_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_ashen_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_BLACK_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_black_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_CHESTNUT_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_chestnut_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_RUSTY_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_rusty_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_SNOWY_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_snowy_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_SPOTTED_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_spotted_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_STRIPED_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_striped_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_WOODS_ANGRY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_woods_angry_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_ASHEN_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_ashen_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_BLACK_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_black_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_CHESTNUT_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_chestnut_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_RUSTY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_rusty_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_SNOWY_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_snowy_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_SPOTTED_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_spotted_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_STRIPED_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_striped_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_WOODS_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_woods_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_ASHEN_TAME_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_ashen_tame_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_BLACK_TAME_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_black_tame_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_CHESTNUT_TAME_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_chestnut_tame_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_TAME_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_tame_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_RUSTY_TAME_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_rusty_tame_baby.png", new Vector2i(12, 12));
    public static final Icon WOLF_SNOWY_TAME_BABY = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/wolf/wolf_snowy_tame_baby.png", new Vector2i(12, 12));
    ...
    public static final Icon ZOMBIE_NAUTILUS_TEMPERATE = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/zombie_nautilus/zombie_nautilus_temperate.png", new Vector2i(12, 12));
    public static final Icon ZOMBIE_NAUTILUS_WARM = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/zombie_nautilus/zombie_nautilus_warm.png", new Vector2i(12, 12));
    public static final Icon ZOMBIE_VILLAGER_DESERT = new SimpleIcon("assets/bluemap-entities/modules/mobs/img/zombie_villager/zombie_villager_desert.png", new Vector2i(12, 12));
