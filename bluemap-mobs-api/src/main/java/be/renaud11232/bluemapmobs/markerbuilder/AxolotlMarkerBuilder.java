...
public class AxolotlMarkerBuilder extends AgeableSingleVariantMarkerBuilder<Axolotl, Axolotl.Variant> {
    public AxolotlMarkerBuilder(BlueMapEntitiesAPI api) {
        super(api);
        registerVariantAdultIcon(Axolotl.Variant.LUCY, MobsIcon.LUCY_AXOLOTL);
        registerVariantAdultIcon(Axolotl.Variant.WILD, MobsIcon.WILD_AXOLOTL);
        registerVariantAdultIcon(Axolotl.Variant.GOLD, MobsIcon.GOLD_AXOLOTL);
        registerVariantAdultIcon(Axolotl.Variant.CYAN, MobsIcon.CYAN_AXOLOTL);
        registerVariantAdultIcon(Axolotl.Variant.BLUE, MobsIcon.BLUE_AXOLOTL);
