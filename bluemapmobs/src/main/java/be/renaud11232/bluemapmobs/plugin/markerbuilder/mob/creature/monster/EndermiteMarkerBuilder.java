...
public class EndermiteMarkerBuilder extends AbstractMobMarkerBuilder<Endermite> {
    public EndermiteMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
