...
public class BeeMarkerBuilder extends AbstractMobMarkerBuilder<Bee> {
    public BeeMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
