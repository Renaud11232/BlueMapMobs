...
public class BambooRaftMarkerBuilder extends AbstractVehicleMarkerBuilder<BambooRaft> {
    public BambooRaftMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
