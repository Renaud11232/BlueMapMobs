...
public class IllusionerMarkerBuilder extends AbstractMobMarkerBuilder<Illusioner> {
    public IllusionerMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
