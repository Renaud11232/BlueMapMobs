...
public class OcelotMarkerBuilder extends AbstractMobMarkerBuilder<Ocelot> {
    public OcelotMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
