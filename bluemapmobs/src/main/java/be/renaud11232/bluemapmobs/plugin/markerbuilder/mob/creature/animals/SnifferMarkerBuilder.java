...
public class SnifferMarkerBuilder extends AbstractMobMarkerBuilder<Sniffer> {
    public SnifferMarkerBuilder(BlueMapAPI api, FileConfiguration config, FileConfiguration defaultConfig) {
