...
public class AcaciaBoatMarkerBuilder extends SimpleMarkerBuilder<AcaciaBoat> {
    public AcaciaBoatMarkerBuilder(BlueMapEntitiesAPI api) {
        super(api);
    }

    @Override
    public Icon getDefaultIcon() {
        return VehiclesIcon.ACACIA_BOAT;
    }
}
