...
import be.renaud11232.bluemapvehiclemarkers.fabric.entity.FabricUnknownVehicle;
import be.renaud11232.bluemapvehiclemarkers.fabric.entity.boat.FabricChestRaft;
import be.renaud11232.bluemapvehiclemarkers.fabric.entity.boat.FabricRaft;
import be.renaud11232.bluemapvehiclemarkers.fabric.entity.boat.FabricRideableBoat;
import be.renaud11232.bluemapvehiclemarkers.fabric.entity.boat.FabricRideableChestBoat;
import be.renaud11232.bluemapvehiclemarkers.fabric.entity.minecart.*;
...
public class FabricVehicleConverter implements EntityConverter<VehicleEntity, Vehicle> {
    @Override
