...
public class VindicatorTextureConverter extends TextureConverter {
    public VindicatorTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^vindicator\\.png$")),
                        List.of("vindicator.png")
                )
        );
    }
}
