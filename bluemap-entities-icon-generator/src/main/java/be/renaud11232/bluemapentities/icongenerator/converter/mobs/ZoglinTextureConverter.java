...
public class ZoglinTextureConverter extends TextureConverter {
    public ZoglinTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^zoglin\\.png$")),
                        List.of("zoglin.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^zoglin_baby\\.png$")),
                        List.of("zoglin_baby.png")
                )
        );
    }
}
