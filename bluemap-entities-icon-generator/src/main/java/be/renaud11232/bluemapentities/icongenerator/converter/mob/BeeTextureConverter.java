...
public class BeeTextureConverter extends TextureConverter {
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                ...
                Map.entry(
                        List.of(Pattern.compile("^bee\\.png$")),
                        List.of("bee_nectar_none.png")
                ),
                Map.entry(
                ...
                Map.entry(
                        List.of(Pattern.compile("^bee_baby\\.png$")),
                        List.of("bee_nectar_none_baby.png")
                ),
                Map.entry(
