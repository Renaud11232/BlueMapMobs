...
public class ZombieHorseTextureConverter extends TextureConverter {
    public ZombieHorseTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^zombie_horse\\.png$")),
                        List.of("zombie_horse.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^zombie_horse_baby\\.png$")),
                        List.of("zombie_horse_baby.png")
                )
        );
    }
}
