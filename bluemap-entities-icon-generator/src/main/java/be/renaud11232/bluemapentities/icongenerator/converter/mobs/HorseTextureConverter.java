...
public class HorseTextureConverter extends TextureConverter {
    public HorseTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^horse_((?:black|brown|chestnut|creamy|darkbrown|gray)|markings_(?:blackdots|white|whitedots|whitefield))\\.png$")),
                        List.of("horse_$1.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^horse_((?:black|brown|chestnut|creamy|darkbrown|gray)|markings_(?:blackdots|white|whitedots|whitefield))_baby\\.png$")),
                        List.of("horse_$1_baby.png")
                )
        );
    }
}
