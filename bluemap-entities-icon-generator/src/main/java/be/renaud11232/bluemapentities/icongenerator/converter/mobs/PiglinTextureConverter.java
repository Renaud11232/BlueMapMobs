...
public class PiglinTextureConverter extends TextureConverter {
    public PiglinTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^piglin\\.png$")),
                        List.of("piglin.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^piglin_baby\\.png$")),
                        List.of("piglin_baby.png")
                )
        );
    }
}
