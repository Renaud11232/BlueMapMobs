...
public class PufferFishTextureConverter extends TextureConverter {
    public PufferFishTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^pufferfish\\.png$")),
                        List.of("puffer_fish.png")
                )
        );
    }
}
