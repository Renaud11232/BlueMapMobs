...
public class DonkeyTextureConverter extends TextureConverter {
    public DonkeyTextureConverter() {
        super();
    ...
    protected List<Map.Entry<List<Pattern>, List<String>>> getConversions() {
        return List.of(
                Map.entry(
                        List.of(Pattern.compile("^donkey\\.png$")),
                        List.of("donkey.png")
                ),
                Map.entry(
                        List.of(Pattern.compile("^donkey_baby\\.png$")),
                        List.of("donkey_baby.png")
                )
        );
    }
}
